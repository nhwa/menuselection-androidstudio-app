...
public class Random_place extends AppCompatActivity {
    ...
    private String[] random_menu_title;
    private String[] random_tel;
    private String[] random_location;
    private String[] random_menutxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(menu_choice.equals("han")) {
            ...
            int i = rand.nextInt(random_menu_title.length);
            ...
            int i = (int)(Math.random() * random_menu_title.length);
            menu_title.setText(random_menu_title[i]);
            tel.setText(random_tel[i]);
            location.setText(random_location[i]);
            menutxt.setText(random_menutxt[i]);
