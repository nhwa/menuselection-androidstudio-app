...
public class PlaceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.fragment_place, container, false);
        ...
        all_random.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((MainActivity)getActivity()).random_place("no_menu");
        ...
        menu_choice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((MainActivity)getActivity()).onMenu_choice_place();
            }
        });
